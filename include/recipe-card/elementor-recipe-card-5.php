	...
	<a href="<?php echo $settings['button_link']; ?>">
		...
		<div class="recipe-container">
			...
			<div class="dish-name elementor-recipe-name-wrapper"><?php echo $settings['dish_name']; ?>
				<p class="dish-type elementor-recipe-type-wrapper"><?php echo $settings['dish_type']; ?></p>
			</div>
			<p class="dish-description elementor-recipe-description-wrapper"><?php echo $settings['recipe_description']; ?></p>
		</div>
	</a>
</div>
<!-- End Recipe Card -->
